...
from xomlx.networking.discovery import Discovery
from xomlx.networking.peer_handle import PeerHandle
from xomlx.topology.device_capabilities import DeviceCapabilities, device_capabilities, UNKNOWN_DEVICE_CAPABILITIES
from xomlx.helpers import DEBUG, DEBUG_DISCOVERY, get_all_ip_addresses_and_interfaces, get_interface_priority_and_type
